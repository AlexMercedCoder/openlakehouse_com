...
Through the Multi-Catalog feature, Doris can connect directly to external data sources without requiring data to be ingested or copied into its internal storage. Users can map an entire Apache Iceberg, Delta Lake, or Apache Hudi catalog directly into Doris. 
